...
const profileOptions: ProfileOption[] = [
  ...
  {
    icon: <FitnessIcon height={18} width={20} />,
    label: "Fitness",
    link: "/fitness",
  },
...
const MobileSideBar = ({
  ...
  const mobileCategories = [
    ...
    },
    {
      name: "Gainers",
      color: "text-gray-800",
      subcategories: ["Weight gainer", "Mass gainer"],
    },
    {
    ...
    },
    {
      ...
      color: "text-gray-800",
      subcategories: ["Collagen", "Omega-3", "Flaxseed oil", "Biotin", "Mask"],
    },
    {
      name: "Fitness",
      color: "text-gray-800",
    ...
    },
    {
      ...
      color: "text-gray-800",
      subcategories: ["T-shirt", "Shorts", "Jackets"],
    },
  ];
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 linear-gradient-1 z-[100000] hidden max-[750px]:block">
      ...
      {showCategories && (
        <div className="fixed top-0 left-0 w-full h-full bg-white z-[100001] min-[280px]:block max-[450px]:block max-[750px]:hidden">
          ...
          <div className="flex flex-col">
            {mobileCategories.map((category, index) => (
              <div key={index} className="border-b">
                ...
                >
                  <p className={`text-[16px] font-normal ${category.color}`}>
                    {category.name}
                  </p>
                ...
                {expandedCategory === category.name && (
                  <div className="pl-8 pb-4">
                    {category.subcategories.map((subcategory, subIndex) => (
                      <p
                        key={subIndex}
                        className="text-[14px] text-gray-600 py-1"
                      >
                        {subcategory}
                      </p>
                    ))}
