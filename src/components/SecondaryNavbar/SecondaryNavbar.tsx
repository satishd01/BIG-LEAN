    ...
    <div>
      <div className="max-w-full hidden md:flex mx-auto gap-[35px] max-[1300px]:px-5 max-sm:px-2 bg-white flex justify-start p-3 sticky top-0 left-0 w-full z-50 bg-light-grey pt-2 pb-2 pl-[5rem] border-b">
        <div className="flex items-center gap-6">
          ...
          >
            <CategoryIcon />
            <p className="cursor-pointer hover:bg-gray-100 px-5 py-2 text-[14px] not-italic font-normal leading-6 text-gray-600 hover:text-[#E70F0F]">
              Shop By Category
            </p>
            {showCategories && (
              <div style={{ backgroundColor: "#F9F9F9" }} className="absolute top-full flex flex-col font-light left-0 bg-white z-50 border-none whitespace-nowrap h-[55px] rounded-bl-[10px]">
                <div className="w-[234px] h-[55px] bg-[#F9F9F9] rounded-bl-[10px]" style={{ position: "absolute", top: "0" }}>
                  ...
                  >
                    <p className="cursor-pointer hover:bg-gray-100 px-5 py-2 text-[14px] not-italic font-normal leading-6 text-[#1C1C2F] hover:text-[#FF0012]">
                      Sports Nutrition
                    </p>
                    <RightArrowIcon />
                  </div>
                    ...
                    >
                      <div className="flex justify-between gap-1 p-3">
                        <div className="min-w-[130px] ">
                          <h2 className="cursor-pointer hover:bg-gray-100 px-4 py-0.5 text-[14px] not-italic font-normal leading-4 text-[#1C1C2F] mb-1.5 hover:text-[#FF0012]">
                            Protein
                          </h2>
                          <div>
